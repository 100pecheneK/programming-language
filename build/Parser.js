...
var BinOperatorNode_1 = __importDefault(require("./AST/BinOperatorNode"));
...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.parseParenthese = function () {
    ...
    Parser.prototype.parseFormula = function () {
        var leftNode = this.parseParenthese();
        var operator = this.match(TokenType_1.tokenTypesList.MINUS, TokenType_1.tokenTypesList.PLUS);
        while (operator != null) {
            var rightNode = this.parseParenthese();
            leftNode = new BinOperatorNode_1.default(operator, leftNode, rightNode);
    ...
    Parser.prototype.parseExpression = function () {
        ...
        if (assignOperator != null) {
            ...
            var binaryNode = new BinOperatorNode_1.default(assignOperator, variableNode, rightFormulaNode);
            return binaryNode;
        }
    ...
    Parser.prototype.run = function (node) {
        ...
        if (node instanceof BinOperatorNode_1.default) {
            switch (node.operator.type.name) {
